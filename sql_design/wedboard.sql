...
CREATE TABLE IF NOT EXISTS `mydb`.`WeddingConceptSection` (
  ...
  `answer_5_food` INT NULL,
  `answer_5_drinks` INT NULL,
  `answer_5_decoration` INT NULL,
  `answer_5_illumination` INT NULL,
  `answer_5_music` INT NULL,
  `answer_5_place` INT NULL,
  `answer_5_flowers` INT NULL,
  `answer_5_service` INT NULL,
  `answer_5_photo` INT NULL,
  `answer_5_video` INT NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`WeddingDaySection` (
  ...
  `answer_2` VARCHAR(255) NULL,
  `answer_3` VARCHAR(255) NULL,
  `answer_4` TINYINT NULL,
  `answer_5` TINYINT NULL,
  `answer_6` VARCHAR(255) NULL,
  `answer_7` VARCHAR(255) NULL,
